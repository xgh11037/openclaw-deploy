...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  },
  {
    ...
    modelIdPlaceholder: 'gpt-5.5 / gpt-5.4 / gpt-5.1 / gpt-4.1 / gpt-4o',
  ...
  },
  {
    ...
    showModelId: true,
    showModelIdInDevModeOnly: true,
    modelIdPlaceholder: 'gemini-3-pro-preview / gemini-3-flash-preview / gemini-2.5-pro / gemini-2.5-flash',
    apiKeyUrl: 'https://aistudio.google.com/app/apikey',
  },
  { id: 'openrouter', name: 'OpenRouter', icon: '🌐', placeholder: 'sk-or-v1-...', model: 'Multi-Model', requiresApiKey: true, showModelId: true, modelIdPlaceholder: 'anthropic/claude-opus-4-7 / openai/gpt-5.5 / google/gemini-3-pro-preview', defaultModelId: 'anthropic/claude-opus-4-7' },
  {
    id: 'yunrui-relay',
    name: '云睿中转站',
    icon: '☁️',
    placeholder: '输入云睿中转站 API Key',
    model: 'GPT / Claude / Gemini',
    requiresApiKey: true,
    defaultBaseUrl: (import.meta.env.VITE_YUNRUI_RELAY_API_BASE_URL || 'https://www.yunruiai.xyz/v1').trim(),
    showBaseUrl: true,
    showModelId: true,
    modelIdPlaceholder: 'gpt-5.5 / gpt-5.4 / gpt-5.1 / gpt-5 / gpt-4.1 / gpt-4.1-mini / gpt-4.1-nano / gpt-4o / gpt-4o-mini / o4-mini / o3 / o3-mini / ...',
    defaultModelId: 'gpt-5.5',
    apiKeyUrl: (import.meta.env.VITE_YUNRUI_RELAY_STATION_URL || 'https://www.yunruiai.xyz').trim() || undefined,
  },
